...
g = './precomputed/linkage_1/pre/{0}.csv'
...
for sample in samples:
    ...
    mx = get_corr(sample=sample, measure='pearson', direct='direct', treat=False)
    ...
    mx = get_corr(sample=sample, measure='pearson', direct='partial', treat=False)
    ...
    mx = get_corr(sample=sample, measure='kendall', direct='direct', treat=False)
    ...
    mx = get_corr(sample=sample, measure='mutual_info', direct='direct', treat=False)
    ...
    stated.to_csv(d.format(sample, 'static'))
